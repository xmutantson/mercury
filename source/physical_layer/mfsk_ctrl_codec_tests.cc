...
// (arq_common.cc:6784) but lives standalone so the tests don't pull in the
// full ARQ controller. Polynomial = POLY_CRC12 = 0xF13 (CRC-12 CDMA2000,
// MSB-first / forward, no init/xorout reflection).
...
int run_mfsk_ctrl_codec_tests() {
	g_failures = 0;
	g_passes   = 0;
	printf("=== MFSK ctrl-suffix codec tests (Phase B Wave 1) ===\n");
