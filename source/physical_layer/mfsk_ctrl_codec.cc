...
//
// Same true-degree-3 GF(16)-RA construction as above, but with a runtime K_info
// and heap storage so it scales to ROBUST_3's data-frame payload (K_info ≈ 200).
// Reuses the field tables / gf_mul / fwht16 / pd_* / log_i0_approx defined
// above. Independent graph storage (g_k_*) so the K=13 ctrl path is untouched.
// =============================================================================
